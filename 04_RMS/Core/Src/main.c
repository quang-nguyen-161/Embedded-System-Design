...
int main(void)
{
  ...
  osThreadDef(aht10_task, aht10_task_start, osPriorityHigh, 0, 128);
  ...
  osThreadDef(uart_task, uart_task_start, osPriorityNormal, 0, 128);
  uart_taskHandle = osThreadCreate(osThread(uart_task), NULL);

  /* definition and creation of oled_task */
  osThreadDef(oled_task, oled_task_start, osPriorityBelowNormal, 0, 128);
